<template>
  <div id="app">
    <div style="position: relative; width: 100vw; height: 100vh; overflow-y: scroll">
      <van-sticky>
        <div style="height: 100px; background: #ccc">吸顶元素</div>
      </van-sticky>
      <div style="height: 500px; background: #ebeef5">长元素</div>
      <div id="nav">
...
<script>
// import VanSticky from "./components/VanSticky";
export default {
  watch: {
